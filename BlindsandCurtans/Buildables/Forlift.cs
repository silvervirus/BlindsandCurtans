...
namespace BlindsandCurtains.Gen
{
    public class Forklift
    {
        ...
        {
            Buildablefl.Register();
        }
    }

    public static class Buildablefl
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("fl", "ForkLift", "Add a Forklift to your base!", "English")
            .WithIcon(CandB.GetSprite("OpenC"));

        public static void Register()
        {
            CustomPrefab prefab = new CustomPrefab(Info);
            CloneTemplate curtainsClone = new CloneTemplate(Info, "13d0fb01-2957-49e0-b153-6dc88332694c");
            ...
            Forklift.techType = Info.TechType;
        }
    }
}
