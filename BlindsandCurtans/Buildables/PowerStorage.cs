...
namespace BlindsandCurtains.Gen
{
    public class PowerStorage
    {
        ...
        {
            Buildableps.Register();
        }
    }

    public static class Buildableps
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PS", "Power Storage", "Add a Power Storage to your base!", "English")
            .WithIcon(CandB.GetSprite("OpenC"));

        public static void Register()
        {
            CustomPrefab prefab = new CustomPrefab(Info);
            CloneTemplate curtainsClone = new CloneTemplate(Info, "33b842e1-0837-40e1-a3d6-58f27d242be3");
            ...
            curtainsClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("power_storage_01 (1)").gameObject;
                ...
                mainModelCollider.size = new Vector3(0.8f, 0.8f, 0.8f);
            ...
            PowerStorage.techType = Info.TechType;
        }
    }
}
