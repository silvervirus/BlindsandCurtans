...
namespace BlindsandCurtains.Gen
{
    public class subcons
    {
        ...
        {
            Buildablsbc.Register();
        }
    }

    public static class Buildablsbc
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("sbc", "Console", "Add a console to your base!", "English")
        ...
        public static void Register()
        {
            ...
            curtainsClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("Submarine_console").gameObject;
