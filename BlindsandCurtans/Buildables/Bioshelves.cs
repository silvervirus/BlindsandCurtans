...
{
    public class bioShelves
    {
        public static TechType techType;
        public static void Patch()
        {
            BuildableBS.Register();
        }
    }

    public static class BuildableBS
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("BS", "BioDome shelves ", "Add a BioDome shelves to your base!", "English")
            .WithIcon(CandB.GetSprite("OpenC"));

        public static void Register()
        {
            CustomPrefab prefab = new CustomPrefab(Info);
            CloneTemplate curtainsClone = new CloneTemplate(Info, "33acd899-72fe-4a98-85f9-b6811974fbeb");
            ...
            curtainsClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("biodome_lab_shelf_01").gameObject;
